...
/**
 * change one vector into unit vector
 * @param b {Vector3}
 * @return {Vector3}
 * @constructor
 */
function VectorNormalize(b) {
    var v = new Vector3();
    var length = VectorLength(b);
    if (length - 0.00001 > 0) {
        v.elements[0] = b.elements[0] / length;
        v.elements[1] = b.elements[1] / length;
        v.elements[2] = b.elements[2] / length;
    }
    return v;
}
